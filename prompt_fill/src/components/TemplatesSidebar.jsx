...
import { Search, RotateCcw, Globe, Settings, ArrowUpDown, Home, Pencil, Copy as CopyIcon, Download, Trash2, Plus, FoldVertical, UploadCloud, Bell } from 'lucide-react';
        ...
        <div className="flex-shrink-0 p-5 border-b border-gray-200 bg-white sidebar-header-min-height">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="relative">
                      <button onClick={() => setIsSortMenuOpen(!isSortMenuOpen)} className="p-1.5 rounded-lg transition-colors text-gray-400 hover:text-orange-600 hover:bg-orange-50 min-touch-target flex items-center justify-center" title={t('sort')}><ArrowUpDown size={16} /></button>
                      {isSortMenuOpen && (
