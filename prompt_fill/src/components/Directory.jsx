...
const TemplateItem = ({ t_item, activeTemplateId, drafts, setActiveTemplateId, onRenameTemplate, saveTemplateName, editingTemplateNameId, tempTemplateName, setTempTemplateName, language, onDuplicateTemplate, onDeleteTemplate, displayTag, t }) => {
  const isDraft = drafts && drafts[t_item.id] !== undefined;
